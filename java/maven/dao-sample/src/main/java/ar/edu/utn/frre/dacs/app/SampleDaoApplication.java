 ...
 * docker run --name pacientes -p 5432:5432 -e POSTGRES_DB=dacs -e POSTGRES_PASSWORD=password -e POSTGRES_USER=postgres -d postgres
...
public class SampleDaoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		SearchCriteria<Paciente> criteria = new EqualPropertySeachCriteria<Paciente>("nombre", "Jorge");
//		new AndSearchCriteria<Paciente>(
