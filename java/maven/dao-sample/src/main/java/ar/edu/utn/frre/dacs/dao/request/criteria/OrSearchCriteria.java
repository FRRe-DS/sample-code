 ...
 * @version 1.0
 */
public class OrSearchCriteria<T> extends CompositeSearchCriteria<T> {

	/**
	 * @param lhs
	 * @param rhs
	 */
	public OrSearchCriteria(SearchCriteria<T> lhs, SearchCriteria<T> rhs) {
		super(lhs, rhs);
	}
	...
	protected Predicate buildCompositeOperator(CriteriaBuilder cb, Expression<Boolean> lhsExpression,
		...
		return cb.or(lhsExpression, rhsExpression);
	}
