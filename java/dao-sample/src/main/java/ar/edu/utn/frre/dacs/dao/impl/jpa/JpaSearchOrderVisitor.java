 ...
 * @version 1.0
 */
public class JpaSearchOrderVisitor<T> implements SearchOrderVisitor<T> {

	@Override
	public Object visit(Map<String, Object> context, SearchOrder<T> criteria) {
		if(criteria == null)
			return null;
		return criteria.acceptOrder(context, this);
	}
}
